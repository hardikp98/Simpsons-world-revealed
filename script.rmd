...
labs(x = "Episode", y = "Lines", color = "Character", title = "Character lines (per episode)", subtitles = "Four main characters") -> d1
script_lines_character_df[complete.cases(script_lines_character_df$word_count),] %>% 
filter(name %in% main_chracters) %>%
group_by(name, episode_id) %>%
...
theme_bw() +
theme(legend.position = "right") +
labs(x = "Episode", y = "Words", color = "Character", title = "Character words(per episode)", subtitle = "Four main characters") -> d2
